...
def generate_blog_draft(keyword, api_key):
    ...
    사용자가 입력한 주제({keyword})를 바탕으로 아래의 6가지 조건을 철저히 지켜 블로그 초안을 작성해 주세요.
    ...
    4. 📏 분량 (500자 이상 필수)
       - 블로그 본문 내용이 너무 짧지 않도록, 반드시 공백을 포함하여 500자 이상으로 상세하고 풍부하게 작성해 주세요.
    
    5. 🔍 검색 및 AI 인용 최적화 제목 + 해시태그 30개
